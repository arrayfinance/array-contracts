...
contract Power {
  ...
  */
    ...
    */
    function floorLog2(uint256 _n) internal returns (uint8) {
        uint8 res = 0;
        uint256 n = _n;
    ...
    */
    function findPositionInMaxExpArray(uint256 _x) internal returns (uint8) {
    ...
    */
    function fixedExp(uint256 _x, uint8 _precision) internal returns (uint256) {
        uint256 xi = _x;
        uint256 res = 0;
